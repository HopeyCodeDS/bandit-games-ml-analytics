...
This repository contains a MySQL database and Statistics API for game analytics.
...
3. **To use the services, you just need to**:
```bash
# Pull the images
docker pull opeyemimomodu/statistics-api:latest
docker pull mysql:latest

# Clone your repository or copy the docker-compose.yml
